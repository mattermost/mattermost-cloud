...
//go:generate mockgen -package=mocks -destination ./rds.go github.com/aws/aws-sdk-go/service/rds/rdsiface RDSAPI
//go:generate mockgen -package=mocks -destination ./s3.go github.com/aws/aws-sdk-go/service/s3/s3iface S3API
//go:generate mockgen -package=mocks -destination ./acm.go github.com/aws/aws-sdk-go/service/acm/acmiface ACMAPI
//go:generate mockgen -package=mocks -destination ./iam.go github.com/aws/aws-sdk-go/service/iam/iamiface IAMAPI
//go:generate mockgen -package=mocks -destination ./route53.go github.com/aws/aws-sdk-go/service/route53/route53iface Route53API
//go:generate mockgen -package=mocks -destination ./kms.go github.com/aws/aws-sdk-go/service/kms/kmsiface KMSAPI
//go:generate mockgen -package=mocks -destination ./secrets_manager.go github.com/aws/aws-sdk-go/service/secretsmanager/secretsmanageriface SecretsManagerAPI
//go:generate mockgen -package=mocks -destination ./resource_tagging.go github.com/aws/aws-sdk-go/service/resourcegroupstaggingapi/resourcegroupstaggingapiiface ResourceGroupsTaggingAPIAPI
