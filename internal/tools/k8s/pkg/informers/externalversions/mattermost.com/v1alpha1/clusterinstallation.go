...
import (
	...
	mattermostcomv1alpha1 "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/apis/mattermost.com/v1alpha1"
	versioned "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/clientset/versioned"
	internalinterfaces "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/listers/mattermost.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1alpha1().ClusterInstallations(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1alpha1().ClusterInstallations(namespace).Watch(options)
			},
		},
		&mattermostcomv1alpha1.ClusterInstallation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInstallationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mattermostcomv1alpha1.ClusterInstallation{}, f.defaultInformer)
}
