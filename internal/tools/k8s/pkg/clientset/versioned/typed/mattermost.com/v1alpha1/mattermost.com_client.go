...
import (
	v1alpha1 "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/apis/mattermost.com/v1alpha1"
	"github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/clientset/versioned/scheme"
...
// ExampleV1alpha1Client is used to interact with features provided by the example.crd.code-generator.k8s.io group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) ClusterInstallations(namespace string) ClusterInstallationInterface {
