...
var clusterinstallationsResource = schema.GroupVersionResource{Group: "example.crd.code-generator.k8s.io", Version: "v1alpha1", Resource: "clusterinstallations"}

var clusterinstallationsKind = schema.GroupVersionKind{Group: "example.crd.code-generator.k8s.io", Version: "v1alpha1", Kind: "ClusterInstallation"}
