...
import (
	...
	scheme "github.com/mattermost/mattermost-cloud/internal/tools/k8s/pkg/clientset/versioned/scheme"
...
func newClusterInstallations(c *ExampleV1alpha1Client, namespace string) *clusterInstallations {
