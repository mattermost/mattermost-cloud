...
const (
	...
	// DefaultScheduledEncryptionKeyDeletion is the default number of days that AWS will take to delete an encryption key.
	DefaultScheduledEncryptionKeyDeletion = 45
)
