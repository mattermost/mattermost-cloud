...
require (
	...
	github.com/mattermost/mattermost-operator v1.25.10-0.20260901142257-b03fd868c0fc // TODO: update to v2.0.0 once https://github.com/mattermost/mattermost-operator/pull/470 is merged and tagged
