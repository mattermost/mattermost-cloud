...
var serverCmd = &cobra.Command{
	...
	RunE: func(command *cobra.Command, args []string) error {
		...
		// Create a single instance of an AWS session.
		sess, err := awstools.NewAWSSession()
		if err != nil {
			return err
		}

		awstools.MargeSessionConfig(&awssdk.Config{
		...
		awstools.AddSessionLoggingHandler(logger)

		// Create a single instance of an AWS client.
		awsClient := awstools.NewAWSClient(sess)
