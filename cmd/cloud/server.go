...
func init() {
	...
	serverCmd.PersistentFlags().Bool("cluster-supervisor", false, "Whether this server will run a cluster supervisor or not.")
	serverCmd.PersistentFlags().Bool("installation-supervisor", false, "Whether this server will run an installation supervisor or not.")
	serverCmd.PersistentFlags().Bool("cluster-installation-supervisor", false, "Whether this server will run a cluster installation supervisor or not.")
	...
	serverCmd.PersistentFlags().Bool("use-existing-aws-resources", false, "Whether to use existing AWS resources (VPCs, subnets, etc.) or not.")
