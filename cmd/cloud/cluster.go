...
func init() {
	...
	clusterUpgradeCmd.Flags().Int("wait-between-rotations", 180, "Τhe time to wait between each rotation of a group of nodes.")
	clusterUpgradeCmd.Flags().Int("wait-between-drains", 1800, "The time to wait between each node drain in a group of nodes.")
	clusterUpgradeCmd.Flags().Int("wait-between-pod-evictions", 5, "The time to wait between each pod eviction in a node drain.")
