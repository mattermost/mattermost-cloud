...
func init() {
	...
	clusterCreateCmd.Flags().String("prometheus-version", model.PROMETHEUS_DEFAULT_VERSION, "The version of Prometheus to provision, latest stable version if omitted.")
	clusterCreateCmd.Flags().String("fluentbit-version", model.FLUENTBIT_DEFAULT_VERSION, "The version of Fluentbit to provision, latest stable version if omitted.")
	clusterCreateCmd.Flags().String("nginx-version", model.NGINX_DEFAULT_VERSION, "The version of Nginx to provision, latest stable version if omitted.")

	clusterProvisionCmd.Flags().String("cluster", "", "The id of the cluster to be provisioned.")
	clusterProvisionCmd.Flags().String("prometheus-version", model.PROMETHEUS_DEFAULT_VERSION, "The version of Prometheus to provision, no change if omitted. Use \"stable\" as an argument to this command to indicate that you wish to remove the pinned version and return the utility to tracking the latest version.")
	clusterProvisionCmd.Flags().String("fluentbit-version", model.FLUENTBIT_DEFAULT_VERSION, "The version of Fluentbit to provision, no change if omitted. Use \"stable\" as an argument to this command to indicate that you wish to remove the pinned version and return the utility to tracking the latest version.")
	clusterProvisionCmd.Flags().String("nginx-version", model.NGINX_DEFAULT_VERSION, "The version of Nginx to provision, no change if omitted. Use \"stable\" as an argument to this command to indicate that you wish to remove the pinned version and return the utility to tracking the latest version.")
